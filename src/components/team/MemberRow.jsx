...
export default function MemberRow({
  ...
  return (
    <tr className={member.status === 'deactivated' ? 'bg-gray-50 opacity-60' : ''}>
      {/* Member Info */}
        ...
        <div className="relative">
          ...
          {showRoleMenu && (
            <>
              ...
              <div className="absolute left-0 mt-1 w-36 bg-white border border-gray-200 rounded-lg shadow-lg z-20 py-1">
                {!memberIsOwner && (
                  <>
                    {isOwner && (
                      <button
