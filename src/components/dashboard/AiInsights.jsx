      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400">{insights.length} recommendations</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-3">
        {insights.map((insight) => {
          ...
          return (
            <div
              key={insight.id}
              className="group p-3 rounded-lg border border-gray-100 hover:border-brand-200 hover:bg-brand-50/20 transition-all cursor-pointer"
            >
