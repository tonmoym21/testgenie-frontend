...
import {
  Beaker, Loader2, Eye, EyeOff, ArrowRight, CheckCircle2, ShieldCheck,
  Sparkles, Zap
} from 'lucide-react';
    ...
    <div className="min-h-screen flex bg-surface-50">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[11px] uppercase tracking-[0.18em] text-brand-300/80">Build · Run · Trust</div>
            </div>
          </div>
            ...
            <div className="space-y-3">
              {HIGHLIGHTS.map(({ icon: Icon, title, text }) => (
                <div key={title} className="flex items-start gap-3 p-3 rounded-xl bg-white/5 ring-1 ring-white/10 backdrop-blur-sm">
                  <div className="w-9 h-9 rounded-lg bg-brand-500/20 text-brand-200 flex items-center justify-center shrink-0">
                    <Icon size={18} />
                  </div>
                  <div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-10">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            <h2 className="text-[26px] font-semibold tracking-tight text-surface-900">
